...
/// unique_ptr error !!!
#include "src/ApplicationServer/ManagerProxy/Subjects/OrderManagerSubject.h"
#include "src/ApplicationServer/ManagerProxy/Subjects/AccountManagerSubject.h"
#include "src/ApplicationServer/ManagerProxy/Subjects/TokenManagerSubject.h"
#include "src/ApplicationServer/ManagerProxy/AuthenticationCarrier/AuthenticationCarrier.h"
/// unique_ptr error !!!
