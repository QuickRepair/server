...
public:
	...
	virtual Account *login(AccountType type, std::string account, std::string password) = 0;
	virtual void createOrUpdatePasswordForAccount(AccountType type, std::string account, std::string password) = 0;
...
//	virtual void registerAuthenticationCarrier(std::shared_ptr<AuthenticationCarrier> carrier) = 0;
	...
	virtual MerchantAccount *getMerchant(AccountId id) = 0;
//	virtual std::weak_ptr<MerchantAccount> getMerchant(const std::string &account) = 0;
	...
	virtual CustomerAccount *getCustomer(AccountId id) = 0;
