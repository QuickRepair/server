...
//	std::shared_ptr<OrderManagerProxy> m_orderManagerProxy;
	...
	std::unordered_map<AccountId, std::unique_ptr<MerchantAccount>> m_merchantAccounts;
	std::unordered_map<AccountId, std::unique_ptr<CustomerAccount>> m_customerAccounts;
};
