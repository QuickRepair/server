...
public:
	...
	virtual std::shared_ptr<Account> readAccount(std::string account, std::string password) = 0;
...
//	virtual std::shared_ptr<Account> loadAccount(unsigned long id) = 0;
	...
	virtual std::shared_ptr<Account> createOrUpdateAccount(std::string account, std::string password) = 0;
